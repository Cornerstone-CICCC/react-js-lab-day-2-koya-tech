  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-900">
      <div className="bg-gray-800 p-8 rounded-lg shadow-md w-full max-w-md flex flex-col items-center">
        ...
        <p className="mb-4 text-white">Have a great and productive day!</p>
        <div className="w-full mb-4">
          {todos.map(todo => (
            <div key={todo.id} className="flex justify-between items-center bg-gray-700 rounded px-4 py-2 mb-2">
